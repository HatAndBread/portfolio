  ...
  return (
    <div className="side-menu-container">
      ...
      <p className="side-menu-text">
        ...
        computer programmer. I like making things, breaking things, and putting them back together again. Please have a
        look through my projects.
      </p>
      <h3>Programming</h3>
      ...
      <h3>Contact</h3>
      <div className="side-menu-text sns">
